  ...
  return <section>
    <div className='container mx-auto min-h-[800px] mb-14'>
      ...
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
        ...
        <div className='text-3x1 font-semibold text-red-500'>$ {house.price}</div>
      </div>
        ...
        border border-gray-300 rounded-lg px-6 py-8'>
          <div className='flex items-center gap-x-4 mb-8'>
            ...
            <div className='items-center gap-x-4 mb-8'>
              ...
              <Link to='' className='text-red-700 text-sm'>View Listings</Link>
            </div>
            ...
            <form className='flex flex-col gap-y-4'>
              <input className='border border-gray-300 focus:border-red-700 
              ...
              <div className='flex flex-col gap-y-4'>
                <button className='bg-red-700 hover:bg-red-800 text-white rounded p-3 
